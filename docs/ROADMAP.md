...
>
> ⚠️ **0-3 과 0-5 는 아직 열려 있습니다.** 다만 이 둘은 착수를 막지 않습니다. 각각 Phase 2(탈퇴)와 Phase 6(캐릭터) 직전까지 미룰 수 있습니다.
...
>
> ❓ **아직 대기 중** — (1) `pairingCode` **자릿수·문자 구성**. (2) 폴링 **주기**(몇 초마다 호출할지)와 만료 PENDING 정리 배치 주기. **둘 다 임의로 정하지 않고 대기합니다.** (1)이 없으면 페어링 코드 생성기를 만들 수 없어 2-2 착수가 여전히 막혀 있습니다.
